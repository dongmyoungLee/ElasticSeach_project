      ...
      <section class="detail_area">
        ...
        <div class="info">
          ...
          <div>
            <div class="inner">
              <p>동의기간</p>
              <p>2022-08-30 ~ 2022-09-29</p>
            </div>
            <div class="inner">
              <p>동의 수</p>
              <p><span>2,149</span>명</p>
            </div>
          </div>
        </div>
        ...
        <section class="detail_info">
          ...
          <div class="mid">
            <p>청원의 취지</p>
            <p>[학교폭력예방 및 대책에 관련 법률] 조치사항에서 가해자와 피해자의 분리 조치는 선택 또는 요청 항목이 아닌, 학교에서 이행해야 할 의무항목이 되어야 합니다. 의무 항목이 아니고 가해학생의 교실 분리 또는 전학이 조치 항목이 아닐 경우 학교측은 가해자와 피해자를 한 교실에 방치 하기 때문 입니다.

              또한 [학교폭력예방 및 대책에 관련 법률]의 조치사항들은 '학교측에 요청' 또는 '이행에 협조' 등의 식으로 통보에서 그치고 있어, 학교측에서 적극적인 조치를 취하지 않을 경우 제 2차 피해를 야기 시킬 수 밖에 없습니다. </p>
          </div>
          <div class="bot">
            <p>청원의 내용</p>
